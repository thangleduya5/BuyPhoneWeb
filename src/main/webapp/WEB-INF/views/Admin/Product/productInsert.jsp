...
<body>
	...
	<div class="container">
        ...
        <form:form action="Admin/productInsert.htm" class="form-product" modelAttribute="phone" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="form-element">
                    ...
                    <form:input type="text" path="idPhone"/>
                ...
                <div class="form-element">
                    ...
                    <form:input type="number" path="costPhone" placeholder="VND"/>
                ...
                <div class="form-element">
                    ...
                    <input type="text" list="brandName" name="nameBrand"/>
                ...
                <div class="form-element">
                    ...
                    <input type="text" list="screenName" name="nameScreen"/>
                ...
                <div class="form-element form-checkbox">
                    <label class="label-title" for="">Chức năng camera: </label>
                    <div class="checkbox-group">
                    	<c:forEach var="f" items="${functionalCameras}">
                    	    <div class="checkbox__element"><input type="checkbox" name="nameFunctionalCamera" value="${f.nameFunctionalCamera}">${f.nameFunctionalCamera}</div>
                    	</c:forEach>
                    </div>
                    <label for="" class="error"></label>
                </div>
                <div class="form-element form-checkbox">
                    ...
                    <div class="checkbox-group">
                    	<c:forEach var="s" items="${specialFeatures}">
                    	    <div class="checkbox__element"><input type="checkbox" name="nameSpecialFeature" value="${s.nameSpecialFeature}">${s.nameSpecialFeature}</div>
                    	</c:forEach>
                    </div>
                    <label for="" class="error"></label>
                </div>
            ...
            <button name="btnAdd">Thêm mới</button>
            ${message}
        </form:form>
	</div>
</body>

...
<body>
		...
		<div class="link-export__wrapper"><a class="link-export" href="pdf/billUnconfirm.htm">Xuất danh sách</a></div>
		<jsp:useBean id="pagedListHolder" scope="request"
			type="org.springframework.beans.support.PagedListHolder" />
		<c:url value="Admin/billUnConfirm.htm" var="pagedLink">
        ...
        <table>
            ...
            <c:forEach var="s" items="${pagedListHolder.pageList}">
            	<tr>
					...
					<td><a href="Admin/email/${s.idBill}.htm">Xác nhận</a></td>
				</tr>
            </c:forEach>
        </table>
		</div>

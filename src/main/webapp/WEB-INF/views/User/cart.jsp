...
<body>
	...
	<div class="cart-app">
		...
		<div class="cart-app__title">
			...
			<div class="title__item">Màu sắc</div>
		...
		<c:forEach var="b" items="${pagedListHolder.pageList}">
			<div class="cart__item">
				<div class="cart__product">
					<img src="resource/img/imgPhone/${f:substring(b.pk.phone.imagePhone,0,f:indexOf(b.pk.phone.imagePhone,'_'))}"	width="50" alt="">
					<p>${b.pk.phone.namePhone}</p>
				</div>
				
				<div class="cart-detail__item"><fmt:formatNumber type = "currency" value = "${b.pk.phone.costPhone*(1-b.pk.phone.discountPhone/100)}" /></div>
				<div class="cart-detail__item">
					<label >${b.colorDetailBill}</label>
				</div>				
				<div class="cart-detail__item">
					<label >${b.amount}</label>
				</div>
				<div class="cart-detail__item"><fmt:formatNumber type = "currency" value = "${b.pk.phone.costPhone*(1-b.pk.phone.discountPhone/100)*b.amount}" /></div>
				<div class="cart-detail__item">
					<a class="cart__delete" href="User/cart/idBill=${b.pk.bill.idBill}+idPhone=${b.pk.phone.idPhone}.htm?linkDelete">Xóa</a>
				</div>
			</div>
		</c:forEach>
		...
		<a class="btn__buy" href="User/cart/buy.htm">Mua hàng</a>
	</div>

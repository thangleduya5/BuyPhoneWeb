	...
	<div class="header-top__wrap">
		<div class="header-top__item header-top__left">
			<a href="User/home.htm" class="header-top-left__link"> <img
				src="resource/img/FPTShop_logo.png" alt="" class="header__logo">
			</a>
		</div>
		<div class="header-top__item header-top__center">
			<form class="header__search" method="post">
				<input name="namePhone" type="text" class="header-search__input"
				...
				<ul class="header-search__focus">
					<li class="search-focus__item"><a href="">Samsung galaxxy
							22</a></li>
					<li class="search-focus__item"><a href="">Samsung galaxxy
							22</a></li>
				</ul>
			...
			<div class="header__user">
				...
				<ul class="header-user__hover header__hover">	
					<c:if test="${sessionScope.idCustomer!=null}">
						<li class="user__item"><a href="User/info.htm" class="">${idCustomer}</a></li>
				...
				<div class="header-cart__hover header__hover">
					<c:if test="${sessionScope.idCustomer!=null}">
						...
						<c:forEach var="s" items="${sessionScope.detailBills}">
								<li class="cart-hover-list__item"><img src="resource/img/imgPhone/${f:substring(s.pk.phone.imagePhone,0,f:indexOf(s.pk.phone.imagePhone,'_'))}"	width="100" height="100" alt="">
								<p>${s.pk.phone.namePhone} khởi động 5.0 đi ra ngoài Trái Đất</p> 
								<span> <fmt:formatNumber type="currency" value="${s.pk.phone.costPhone}" /> </span>
							</li> 
						<%m= m+1;%>
						</c:forEach>
						</ul>
...
<div class="header-bottom">
	<ul class="header-bottom__list">
		<c:forEach var="s" items="${sessionScope.brands}">
			<li class="header-bottom__item"><a href="User/home/${s.nameBrand}.htm" class="header-bottom__link">${s.nameBrand}</a></li>
		</c:forEach>
	</ul>
</div>

...
<body>
	...
	<div class="cart-app">
		...
		<div class="cart-app__title">
			...
			<div class="title__item">Ngày lập</div>
		...
		<div class="cart__list">
			...
			<c:forEach var="b" items="${pagedListHolder.pageList}">
				<div class="cart__item">
					<div class="cart-detail__item"><label >${b.idBill}</label></div>	
					<div class="cart-detail__item"><label >${b.dateBill}</label></div>
					<div class="cart-detail__item"><fmt:formatNumber type = "currency" value = "${b.costBill}" /></div>
					<div class="cart-detail__item"><label >
						<c:if test="${b.statusBill==1}">Chờ xác nhận</c:if>
						<c:if test="${b.statusBill==2}">Đã hoàn thành</c:if>
					</label></div>
					<div class="cart-detail__item">
						<a class="cart__delete" href="User/history/idBill=${b.idBill}.htm?linkDetail">Xem chi tiết</a>
					</div>			
				</div>
			</c:forEach>
